...
public class PanelImportHocSinh extends JPanel {
    ...
    public PanelImportHocSinh(){
        ...
        model.setColumnIdentifiers(new String[]{
                "Mã HS","Họ Tên","Lớp","Ngày Sinh","Giới Tính","Địa Chỉ"
        });
    ...
    private void preview(){
        ...
        excelBLL.previewHocSinh(txtFile.getText(),model);
    }

    private void importExcel(){

        boolean kq = excelBLL.importHocSinh(new File(txtFile.getText()));
